...
public interface IPasarelaPagoPlugin extends IPlugin {
    ...
    /** Prefix. */
    public static final String PAGO_BASE_PROPERTY = IPLUGIN_BASE_PROPERTIES
            + "paymentib.";
     ...
     */
    UrlRedireccionPasarelaPago iniciarPagoElectronico(DatosPago datosPago,
            String entidadPagoId, String urlCallback)
            throws PasarelaPagoException;
     ...
     * @return estado pago
     */
    EstadoPago verificarRetornoPagoElectronico(DatosPago datosPago,
            String localizador, Map<String, String[]> parametrosRetorno)
            throws PasarelaPagoException;
     ...
     * @return estado pago
     */
    EstadoPago verificarPagoElectronico(DatosPago datosPago, String localizador)
            throws PasarelaPagoException;
     ...
     *         justificante).
     */
    byte[] obtenerJustificantePagoElectronico(DatosPago datosPago,
            String localizador) throws PasarelaPagoException;
